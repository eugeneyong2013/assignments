							...
							<div class="ScrollStyle">
									  <center>
										  <table cellpadding="8" class="table table-hover">			
										  	...
										  	<tr><td><b>No.</b></td><td><b>Full Name</b></td><td><b>Email Address</b></td><td><b>Status</b></td><td><b>Unlock?</b></td></tr>
											<% 
												int checker = 0;
												int numOfRecords = 0;
												int numOfPages = 0;
												...
												ArrayList<Employee> employeeList = (ArrayList<Employee>) session.getAttribute("currentSessionLockedEmployeeList");
												if(employeeList == null || employeeList.isEmpty()){
														...
														for(int i = valueStart; i < valuesLimit; i++){
															...
															%>
																...
																<tr>
																	...
																	<td>
																		<font color="red"><b><%=e.getStatus()%></b></font>
																	</td>
																	<td align="center">
													...
													%><input type="hidden" name="page" value="ViewRequestStatusPage"></form><% 
													if(checker == 0){
														%>
															<tr><td colspan="5" align="center">There is currently no employees</td></tr>
					...
					<nav aria-label="Page navigation example">
  						<ul class="pagination justify-content-center">
    						...
    						<% for(int i = 1; i <= numOfPages; i++){ %>
    							<li class="page-item"><a class="page-link" href="ViewRequestStatusPage.jsp?pageNo=<%=i%>&valuesLimit=<%=i*5%>"><%=i%></a></li>
    						<% } %>
    						<li class="page-item">
